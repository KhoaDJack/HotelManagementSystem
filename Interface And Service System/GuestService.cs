...
namespace HotelDBFinal.InterfaceAndServiceSystem
{
    public class GuestService : IGuestService
    {
        ...
        public async Task<IEnumerable<Guest>> GetPagedAsync(int page, int pageSize)
        {
            ...
            using var connection = _context.CreateConnection();
            return await connection.QueryAsync<Guest>(sql, new { Offset = offset, PageSize = pageSize });
        }
