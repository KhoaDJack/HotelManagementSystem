...
namespace HotelDBFinal.InterfaceAndServiceSystem
{
    public class StaffService : IStaffService
    {
        ...
        public async Task<IEnumerable<Staff>> GetPagedAsync(int page, int pageSize)
        {
            var sql = @"
            SELECT * FROM Staff
            ORDER BY StaffID
            ...
            using var connection = _context.CreateConnection();
            return await connection.QueryAsync<Staff>(sql, new { Offset = (page - 1) * pageSize, PageSize = pageSize });
